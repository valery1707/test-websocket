...
public class PasswordStorage {
	...
	public static final int HASH_ITERATIONS = 64000;
	...
	public static String createHash(String password) throws CannotPerformOperationException {
		return createHash(password.toCharArray(), SALT_BYTE_SIZE, HASH_BYTE_SIZE, HASH_ITERATIONS);
	}

	public static String createHash(char[] password, int saltByteSize, int hashByteSize, int hashIterations) throws CannotPerformOperationException {
		...
		// Hash the password
		byte[] hash = hash(password, salt, hashIterations, hashByteSize);
	...
	public static boolean verifyPassword(char[] password, String correctHash) throws CannotPerformOperationException, InvalidHashException {
		...
		// Currently, Java supports only SHA1.
		...
		byte[] testHash = hash(password, salt, iterations, hash.length);
	...
	private static byte[] hash(char[] password, byte[] salt, int iterations, int bytes) throws CannotPerformOperationException {
		try {
